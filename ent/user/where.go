...
func IsProvider(v bool) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldIsProvider), v))
	})
}
...
func IsProviderNEQ(v bool) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldIsProvider), v))
	})
}
...
func HasService() predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasServiceWith(preds ...predicate.Service) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
